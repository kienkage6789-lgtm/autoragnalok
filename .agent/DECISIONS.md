...
- Bối cảnh:
  ...
  - Người dùng không có cách nào thống kê nhanh số mạng giết được, bị giết và tỉ lệ K/D của bản thân trong sự kiện PvP. Ngoài ra khi chơi tay trên trình duyệt, dữ liệu nhân vật trên server bị đóng băng do bot tự động tạm dừng, dẫn đến tên nhân vật rỗng, và bot không theo dõi được trạng thái sự kiện kích hoạt nên không gọi API lấy log chiến trận.
- Quyết định:
